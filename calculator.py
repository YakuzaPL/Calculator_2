...
class Calculator:
    def __init__(self, parent, x, y):
        self.button_font = ('Veranda', 15)
        self.entry_font = ('Veranda', 20)
        self.parent = parent
    ...
    def entry(self, x_, y_):
        self.entry = Text(
            ...
            height=self.button_hight // 2, width=self.button_width * 5
        )
    ...
    def button(self, char_, x_, y_):
        self.b = Button(
            ...
            height=self.button_hight, font=self.entry_font,
